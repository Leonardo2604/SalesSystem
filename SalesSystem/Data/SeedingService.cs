...
namespace SalesSystem.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d1 = new Department(5, "Computers");
            Department d2 = new Department(6, "Eletronics");
            Department d3 = new Department(7, "Fashion");
            Department d4 = new Department(8, "Books");
